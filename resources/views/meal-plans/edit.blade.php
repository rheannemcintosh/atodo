<x-app-layout>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Edit Meal Plan</h1>
    </div>
    <form action="{{ route('meal-plans.update', $mealPlan) }}" method="POST" class="space-y-6 bg-white px-6 pb-6 rounded-lg border border-gray-200">
        @csrf
        @method('PUT')
        ...
        <div class="flex flex-col">
            ...
            <input
                ...
                class="text-sm mt-1 p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                value="{{ $mealPlan->afternoon_snack }}"
            >
        </div>
        ...
        <div class="flex flex-col">
            ...
            <input
                ...
                class="text-sm mt-1 p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                value="{{ $mealPlan->nighttime_snack }}"
            >
        </div>
